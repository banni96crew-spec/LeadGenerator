...
const examples: Array<{ name: string; data: unknown }> = [
  ...
  },
  {
    ...
    data: {
      ...
      money_loss_summary:
        "Сайт выглядит перегруженным доказательствами «лучшести», но не показывает путь клиента к заявке. Владелец теряет часть обращений из-за шума на первом экране и слабой визуальной иерархии CTA.",
